...
export const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    freeSampleDesc: 'The free sample includes the Cover, Table of Contents, and Chapter 1. The full guide unlocks all 10 chapters.',
  ...
  es: {
    ...
    freeSampleDesc: 'La muestra gratuita incluye la portada, el índice y el capítulo 1. La guía completa desbloquea los 10 capítulos.',
  ...
  fr: {
    ...
    freeSampleDesc: 'L\'échantillon gratuit comprend la couverture, la table des matières et le chapitre 1. Le guide complet débloque les 10 chapitres.',
  ...
  de: {
    ...
    freeSampleDesc: 'Die kostenlose Probe enthält das Cover, das Inhaltsverzeichnis und Kapitel 1. Der vollständige Leitfaden schaltet alle 10 Kapitel frei.',
  ...
  it: {
    ...
    freeSampleDesc: 'Il campione gratuito include la copertina, l\'indice e il capitolo 1. La guida completa sblocca tutti i 10 capitoli.',
  ...
  pt: {
    ...
    freeSampleDesc: 'A amostra grátis inclui a capa, o índice e o capítulo 1. O guia completo desbloqueia todos os 10 capítulos.',
  ...
  zh: {
    ...
    freeSampleDesc: '免费样本包括封面、目录和第1章。完整指南解锁全部10章。',
  ...
  ja: {
    ...
    freeSampleDesc: '無料サンプルには表紙、目次、第1章が含まれています。完全ガイドは全10章をアンロックします。',
