...
<head><title>Copyright</title><link rel="stylesheet" type="text/css" href="styles.css"/></head>
<body>
  <div style="text-align: left; margin-top: 5em; font-size: 0.8em;">
    <p>Copyright © ${new Date().getFullYear()} [Holding Company Name, LLC]</p>
    <p>All rights reserved.</p>
    <p>Published by Loom &amp; Page<br/>www.LoomandPage.com</p>
    ...
    <p>Book generated by Loom &amp; Page AI Engine.</p>
  </div>
</body>
</html>`;
