...
import SearchBar from "@/components/SearchBar"; // Changed from SearchInterface
import { useToast } from "@/components/ui/use-toast";
import { supabase } from "@/integrations/supabase/client";
import Header from "@/components/Header"; // Changed from DashboardHeader
        ...
        {!activeBook && !isGenerating ? (
          <div className="max-w-4xl mx-auto text-center space-y-8 py-20">
            ...
            <div className="pt-10 flex justify-center">
              <SearchBar onSearch={handleGenerate} isLoading={isGenerating} />
            </div>
          </div>
        ) : (
