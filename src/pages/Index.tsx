...
const Index = () => {
  ...
  // NOTE: Image generation is handled by PageViewer via the hybrid engine (fetch-book-images)
  // No duplicate image generation needed here - PageViewer auto-fetches on mount
